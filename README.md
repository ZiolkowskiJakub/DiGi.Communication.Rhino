...
**DiGi.Communication.Rhino** is a C# engineering and architectural software library suite designed for BIM and CAD integrations (such as Revit, RhinoCommon, Grasshopper, and Dynamo BIM).
...
* **[DiGi.Communication.ComputeSharp.Rhino](DiGi.Communication.ComputeSharp.Rhino)** (Path: `DiGi.Communication.Rhino\DiGi.Communication.ComputeSharp.Rhino`)
* **[DiGi.Communication.Rhino](DiGi.Communication.Rhino)** (Path: `DiGi.Communication.Rhino\DiGi.Communication.Rhino`)
